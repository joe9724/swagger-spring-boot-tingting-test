...
public class InlineResponse20020   {
  ...
  @JsonProperty("books")
  @Valid
  private List<Chapter> books = null;

  public InlineResponse20020 status(Response status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20020 books(List<Chapter> books) {
    this.books = books;
    return this;
  }

  public InlineResponse20020 addBooksItem(Chapter booksItem) {
    if (this.books == null) {
      this.books = new ArrayList<Chapter>();
    }
  ...
  **/
  ...
  public List<Chapter> getBooks() {
    return books;
  }

  public void setBooks(List<Chapter> books) {
    this.books = books;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, inlineResponse20020.status) &&
        Objects.equals(this.books, inlineResponse20020.books);
  }
