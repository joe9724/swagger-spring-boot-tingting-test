...
import io.swagger.model.AlbumBuyResult;
...
public class InlineResponse20011   {
  ...
  @JsonProperty("data")
  private AlbumBuyResult data = null;

  public InlineResponse20011 status(Response status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20011 data(AlbumBuyResult data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public AlbumBuyResult getData() {
    return data;
  }

  public void setData(AlbumBuyResult data) {
    this.data = data;
  }
